    ...
    return (
        <div className="min-h-screen bg-black text-white flex items-center justify-center p-4 -mt-16">
            ...
            >
                ...
                >
                    <Link href="/auth/login" className="text-sm text-gray-400 hover:text-gray-300 transition-colors duration-300">
                        Already have an account? <span className="text-cyan-400 hover:text-cyan-300">Login</span>
                    </Link>
                </motion.div>
                <div className="mt-6">
                    <div className="relative">
